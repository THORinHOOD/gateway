package fi.lipp.greatheart.gateway.utils;
...
public class Response<T> {
    ...
    public static <BODY> Response<BODY> EXECUTE_RAW(Supplier<BODY> supplier) {
        try {
    ...
    public static <BODY> Response<BODY> EXECUTE(Supplier<Response<BODY>> supplier) {
        try {
            return supplier.get();
        } catch (Exception exception) {
            return Response.BAD("Неожиданная ошибка:\n" + exception.toString());
